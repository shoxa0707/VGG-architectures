...
class VGG19:
    def __init__(self, include_top=True):
        ...
        self.conv8 = keras.layers.Conv2D(filters=256, kernel_size=3, padding='same', activation='relu')
        # BLOCK4
        ...
        self.conv14 = keras.layers.Conv2D(filters=512, kernel_size=3, padding='same', activation='relu')
        self.conv15 = keras.layers.Conv2D(filters=512, kernel_size=3, padding='same', activation='relu')
        self.conv16 = keras.layers.Conv2D(filters=512, kernel_size=3, padding='same', activation='relu')
